...
1. **Fold operator** (Mechanism 1): `skills/wiki-fold/`, dry-run verified AND first real fold committed at [[fold-k3-from-2026-04-23-to-2026-04-24-n8]].
...
3. **Semantic tiling lint** (Mechanism 3): shipped and activated. `nomic-embed-text` pulled; first tiling report at [[tiling-report-2026-04-24]] (0 errors, 15 review-band pairs).
